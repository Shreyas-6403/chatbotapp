...
public class ChatAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case 2:
                view = LayoutInflater.from(parent.getContext()).inflate(R.layout.bot_imgs, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        switch (chatsmodalArrayList.get(position).getSender()) {
            ...
            case "bot":
                ...
                break;
            case "bot2":
                ((botViewHolder2)holder).botReply.setText(chatsmodal.getMessage());
                break;
    ...
    public static class botViewHolder extends RecyclerView.ViewHolder {
        TextView botReply,Model,Price,botimg;
    ...
    public static class botViewHolder2 extends RecyclerView.ViewHolder {
        TextView botReply,Model,Price;

        public botViewHolder2(@NonNull View itemView) {
            super(itemView);

            botReply = itemView.findViewById(R.id.bot_reply2);
            Model= itemView.findViewById(R.id.tvModel);
            Price= itemView.findViewById(R.id.tvPrice);
